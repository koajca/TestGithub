 ...
 * @version 1.0
 */
public class RetrieveCodeBusiness extends BaseBusiness {

    public RetrieveCodeBusiness() {
        super();
        log = Logger.getLogger(RetrieveCodeBusiness.class);
    }
...
//        transCp.setSessionManager(sm);
                ...
                transCp.setTransType(TransactionType.RETRIEVE_PINCODE.getLongVal());
                ...
                if (transCp != null) {
                    ...
                    if (oldTransCp.getErrorCode() == null) {
                        ...
                        //Giao dich goc da thanh cong => Tra ve pincode
                        this.responseData.put(DataUtils.JSON_KEY.info.toString(), oldTransCp.getPincode());
                        this.responseData.put(DataUtils.JSON_KEY.amount.toString(), oldTransCp.getAmount().longValue() + "");
                    ...
                    } else if (oldTransCp.getErrorCode().equals(ERROR_CODE.ERROR_32.getErrorCode())) {
                        //Giao dich timeout
                        this.responseData.put(DataUtils.JSON_KEY.amount.toString(), oldTransCp.getAmount().longValue() + "");
                    ...
                    this.responseData.put(DataUtils.JSON_KEY.error_code.toString(), ERROR_CODE.ERROR_23.getErrorCode());
                    this.responseData.put(DataUtils.JSON_KEY.error_msg.toString(), ERROR_CODE.ERROR_23.getErrorDesc());
                }
            }
        }
