...
/**
 *
 * @author phucpt@dcv.vn
 * @since Jan 05, 2017
 * @version 1.0
 */
public class QueryTransactionAction extends BaseAction {

    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(QueryTransactionAction.class);
...
//        where += " and cp.trans_type = 0";
        ...
        if (!CommonUtils.isNullOrEmpty(transactionForm.getBankRequest())) {
            where += " and bp.request_id = :bankRequestId";
            hash.put("bankRequestId", transactionForm.getBankRequest());
        }
