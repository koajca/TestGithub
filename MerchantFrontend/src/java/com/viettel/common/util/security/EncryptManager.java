...
//        System.out.println("");
//      RSAkeyObj keypair = genKeys();
//            String publickey = keypair.getPublicKey();
//      String privatekey = keypair.getPrivateKey();
//        String publickey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCnVQ8RbA0lC6TSB5+2OciJkL4RR37iBHyWijdrdhxvcSiTsG3ScJc0q0q9Ok6lr8VTrYgcW8UbS2xPaVcmrag6tn6CYz4LtqCGsf/YFc1NLFdZB9F9UdrEGwNWS3HAfrKBXdpVx7XrL1uPxjygbHtGkr//amj/HaoJ19fb6eMGawIDAQAB";
        String publickey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCnVQ8RbA0lC6TSB5+2OciJkL4RR37iBHyWijdrdhxvcSiTsG3ScJc0q0q9Ok6lr8VTrYgcW8UbS2xPaVcmrag6tn6CYz4LtqCGsf/YFc1NLFdZB9F9UdrEGwNWS3HAfrKBXdpVx7XrL1uPxjygbHtGkr//amj/HaoJ19fb6eMGawIDAQAB";
        String privatekey = "";
        PublicKey pk = getPublicKeyFromString(publickey);
        PrivateKey prk = getPrivateKeyFromString(privatekey);
//                 sun.security.rsa.RSAPrivateCrtKeyImpl privatekeyimpl = (sun.security.rsa.RSAPrivateCrtKeyImpl) prk;
//            System.out.println("Prime exponent p : " + privatekeyimpl.getPrimeExponentP());
//            System.out.println("Prime exponent q : " + privatekeyimpl.getPrimeExponentQ());
//            System.out.println("Modulus : " + privatekeyimpl.getModulus());
//            System.out.println("Private exponent : " + privatekeyimpl.getPrivateExponent());
//            System.out.println("Public exponent : " + privatekeyimpl.getPublicExponent());

        String msisdn = "84977173620";
        String txDate = "20110316140012";
        String cpId = "0";
        String type = "airtime";
        ...
        String amount = "5000";
        String cpGameId = "73";
        String value = msisdn.trim() + txDate.trim() + cpId.trim() + type.trim() + serviceId.trim() + transId.trim() + amount.trim() + cpGameId.trim();
...
//        System.out.println("byte to hex: " + encodeString(input, PASS_PHRASE));
//        System.out.println("hex to byte: " + decodeString(encodeString(input, PASS_PHRASE), PASS_PHRASE.length()));
        System.out.println("encode string: " + encryptRSA(input, publickey));
        System.out.println("decode string: " + decryptRSA(encryptRSA(input, publickey), privatekey));
//        String encryptedString = "";
//                   "I/qQvUJQed4ujSa3AFkVPjzyA/KWIY1LFy1z9FzX2TyytEn+NdGc7iBB97L0ov0NkaEt15zHwURryK1Tuhs+JOmJzf+mGzdqcDl60d8MRp/GMOzkakFRHh6GYaxnsb8vx3kPAhjpN6JddFcuVa2L/pgYqerqhuqtp1P18qmtURQ="
        String sig = "I/qQvUJQed4ujSa3AFkVPjzyA/KWIY1LFy1z9FzX2TyytEn+NdGc7iBB97L0ov0NkaEt15zHwURryK1Tuhs+JOmJzf+mGzdqcDl60d8MRp/GMOzkakFRHh6GYaxnsb8vx3kPAhjpN6JddFcuVa2L/pgYqerqhuqtp1P18qmtURQ=";
        System.out.println("encode string: " + publicEncryptString(input, publickey));
        System.out.println("decode string: " + privateDecryptString(publicEncryptString(input, publickey), privatekey));
//                   value=&mtseq=111&msgtype=text&msgtitle=LoveStory&msgbody=Test_SMS&moseq=12345&mttotalseq=1&mtseqref=1
        value = "value=&mtseq=111&msgtype=text&msgtitle=LoveStory&msgbody=Test_SMS&moseq=12345&mttotalseg=1&mtsegref=1";
        sig = createMsgSignature(value, privatekey);
        boolean kq = verifyMsgSignature(sig, publickey, value);
...
//    private static Logger log = Logger.getLogger(EncryptManager.class);
    static Logger log = Logger.getLogger(EncryptManager.class);
