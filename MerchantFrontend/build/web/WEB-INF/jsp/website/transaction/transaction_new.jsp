        ...
        <table border="0" style="width: 100%; border-collapse: collapse; margin: 0; padding: 0">
            ...
            <tr>
                ...
                <td>
                    <!--<div data-role="fieldcontain">-->
                        <label >Chọn CP</label>
                        <!--<select id="transactionFormcontentProviderId" class="myselect" name="transactionForm.contentProviderId" data-mini="true" data-inline="true" data-iconpos="noicon">-->
                    <div class="ui-widget">
                        <select id="combobox">
                            <option value="-1"><sd:Property>transactionForm.selectAll</sd:Property> </option>
                            <s:iterator value="listContentProvider" var="item" >
                                <option value='<s:property value="#item.CONTENT_PROVIDER_ID" />'> <s:property value="#item.CP_CODE" /> - <s:property value="#item.CP_NAME" /></option>
                            </s:iterator>
                        </select>
                </div>
            </td>
