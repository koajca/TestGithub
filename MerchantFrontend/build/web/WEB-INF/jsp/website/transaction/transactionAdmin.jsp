...
<script>
    ...
    onSearchSuccess: function(data, status)
    {
        ...
        DoSearch: function() {
            ...
            $.ajax({
                type: "POST",
                url: "TransactionAdmin!onSearch.do?",
                cache: false,
                data: formData,
    ...
    $(D).ready(function($) {
        ...
        setDefaultDate();
                ...
                viewDetail = function(transId) {
                    showModal();
                    var url = '${contextPath}' + '/TransactionAdmin!viewDetail.do?transId=' + transId;
...
<form id="transactionForm" name="transactionForm"  novalidate="novalidate">
    <h3><sd:Property>transaction_title</sd:Property></h3>
        ...
        <tr>
            ...
            <td>
                <div data-role="fieldcontain">
                    <label for="transactionForm.bankRequest" ><sd:Property>transactionForm.bankRequest</sd:Property></label>
                        <input id="transactionForm.bankRequest" type="text" value="" name="transactionForm.bankRequest" data-mini="true" data-inline="true" maxlength="30" />
                    </div>
                </td>
                <td>
