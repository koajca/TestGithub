...
<script>
    ...
    (function($, W, D)
    {
        ...
        MERCHANTGW.REPORREFUND =
            {
            setupFormValidation: function()
            {
                //form validation rules
                $("#reportRefundForm").validate({
                    rules: {
                        'fromDate': {
                            required: true,
                            vnDate: true,
                    ...
                    submitHandler: function(form) {
                        MERCHANTGW.REPORREFUND.DoSearch();
                    }
                });
            },
            ...
            DoSearch: function() {
                ...
                var formData = $("#reportRefundForm").serialize() + '&' + $.param(tokenParam);
                $.ajax({
                    type: "POST",
                    url: "Report!onReprotRefund.do?",
                    cache: false,
                    data: formData,
                    success: MERCHANTGW.REPORREFUND.onSearchSuccess,
                    error: MERCHANTGW.REPORREFUND.onError
                });
                return false
            }
        ...
        $(D).ready(function($) {
            MERCHANTGW.REPORREFUND.setupFormValidation();
            setDefaultDate();
        });
...
//            pagesize: 20,
            ...
            columns: [
                ...
                { text: 'Tổng số GD <br/> thành công', datafield: 'TOTALSUCCESS', width: 100, cellsformat: 'n' },
                { text: 'Tổng số GD <br/>chưa xử lý', datafield: 'TOTALPENDING', width: 100, cellsformat: 'n' },
                { text: 'Tổng số GD <br/>thất bại', datafield: 'TOTALFAILURE', width: 100, cellsformat: 'n' },
                { text: 'Tổng tiền GD<br/> thành công', datafield: 'AMOUNTSUCCESS', width: 100, cellsalign: 'right', cellsformat: 'n' },
                { text: 'Tổng tiền GD<br/> chưa xử lý', datafield: 'AMOUNTPENDING', width: 100, cellsalign: 'right', cellsformat: 'n' },
                { text: 'Tổng tiền GD<br/> thất bại', datafield: 'AMOUNTFAILURE', width: 100, cellsalign: 'right', cellsformat: 'n' }
            ]
        });           
    }
...
<form id="reportRefundForm" name="reportRefundForm"  novalidate="novalidate">
    <h3>Báo cáo tổng hợp giao dịch hoàn tiền</h3>
    ...
    <table border="0" style="width: 100%; border-collapse: collapse; margin: 0; padding: 0">
        ...
        <tr>
            ...
            <tr>
                ...
                <input data-mini="true" data-inline="true" type="button" id="btnExcel" name="btnExcel" value="<sd:Property>transactionForm.btnExcel</sd:Property>" onclick="exportExcel('REPORT_REFUND');" />
            </td>
        </tr>
    </table>
</form>
