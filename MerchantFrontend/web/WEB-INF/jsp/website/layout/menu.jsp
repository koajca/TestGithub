...
<div data-role="controlgroup" data-type="horizontal" style="margin: 0px">
    ...
    %>
    <a href="TransactionAdmin.do" data-ajax="false" data-theme="a">Tra cứu giao dịch ngân hàng</a>
    <%            }
    %>
    <%        
    ...
    <a href="ConfirmTransFix.do" data-ajax="false" data-theme="a">Xác nhận điều chỉnh GD</a>
    <%            }
    %>
    <%    
