    ...
    public List<Transaction> getTrans(String where, HashMap param) {
        ...
        try {
            ...
            String sql = "select cp.trans_id transId, cp.content_provider_id contentproviderid,  to_char(cp.request_date, 'dd/MM/yyyy hh24:mi:ss') requestDate, "
                    ...
                    + ")"
                    + " transStatus, "
                    + "nvl (cp.confirm_status, 0) confirmStatus, cp.billing_code billingCode, cp.order_id orderId, cp.amount, "
...
//            DAOFactory.commitCurrentSessions();
     ...
     * @throws Exception
     */
    private Object callGetFunction(Object obj, String getFuncName) throws Exception {
     ...
     * @throws Exception
     */
    private void callSetFunction(Object obj, String setFuncName, Object param) {
        try {
