...
import com.viettel.ttbankplus.servicegw.hibernate.dao.users.UsersPassHisDAO;
...
//        }
    ...
    public static UsersPassHisDAO getUsersPassHisDAO() {
        return UsersPassHisDAO.getInstance(UsersPassHis.class, null);
    }
}
