...
@ManagedBean
@ViewScoped
public class SearchTransactionEVN extends BaseBean implements Serializable {
    ...
    private static final Logger log = Logger.getLogger(SearchTransactionEVN.class);
    ...
    public void onSearch() {
        ...
        log.info("SearchTransactionEVN.onSearch");
        ...
        listTrans = dbProcessor.getTransactionProcessor().getTransEVN(toDate, fromDate, bankCode);
    }
    ...
    public StreamedContent exportExcel() {
        ...
        try {
            ...
            String reportFileName = "TransactionEVN_" + DateTimeUtils.convertDateToString(new Date(), "yyMMddHHmmss") + ".xls";
            String reportFilePath = reportFolder + reportFileName;
            String templateFilePath = templateFolder + "TransactionEVN.xls";
